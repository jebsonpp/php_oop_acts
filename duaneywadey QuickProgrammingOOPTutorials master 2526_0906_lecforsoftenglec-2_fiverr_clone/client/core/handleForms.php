...
if (isset($_POST['insertOfferBtn'])) {
	...
	$existingoffer = $offerObj ->checkIfOfferExists($user_id,$proposal_id); // initializing a variable for checking
	// submits an error if the proposal id is found on another offer
	if ($existingoffer) {
		$_SESSION ['message'] = "You have already Submitted on this proposal, Delete the previous to submit another.";
		$_SESSION ['status'] = '400';
		header("Location: ../index.php");
		exit();
	}
