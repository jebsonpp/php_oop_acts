...
class Article extends Database {
     ...
     */
    public function createArticle($title, $content, $imageName,$author_id) {
        $sql = "INSERT INTO articles (title, content, imageName, author_id, is_active) VALUES (?, ?, ?, ?, 0)";
        return $this->executeNonQuery($sql, [$title, $content,$imageName, $author_id]);
    }
