      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="file" class="form-control mt-4" name="images" placeholder="Insert an Image">
            </div>
          ...
          <div class="card mt-4 shadow articleCard">
            <div class="card-body">
              ...
              <?php 
                // Display the submitted image if available
                if (!empty($article['imageName'])) { 
              ?>
                <img src="../../images/<?php echo $article['imageName']; ?>" alt="Article Image" class="img-fluid mb-3">
              <?php } ?>
