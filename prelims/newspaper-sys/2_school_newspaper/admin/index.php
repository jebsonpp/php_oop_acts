...
<body>
  ...
  <div class="container-fluid">
    <div class="display-4 text-center">
      Hello there and welcome to the admin side! <span class="text-success"><?php echo $_SESSION['username']; ?></span>. Here are all the articles
    </div>
        ...
        <div class="card mt-4 shadow">
          <div class="card-body">
            ...
            <?php if ($article['is_admin'] == 1) { ?>
              <p>
                <small class="bg-primary text-white p-1">Message From Admin</small>
              </p>
            <?php } ?>
            <small>
              <strong><?php echo htmlspecialchars($article['username']); ?></strong> - <?php echo htmlspecialchars($article['created_at']); ?>
            </small>
            ...
            <form action="core/handleForms.php" method="POST">
              ...
              <input type="submit" class="btn btn-danger" name="deleteArticleBtn" value="Delete">
            </form>
          </div>
        </div>  
        <?php } ?> 
