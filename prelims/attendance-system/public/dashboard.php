...
if ($user['role'] === 'admin') {
    ...
    // Handle "Assign User as Student" form
    ...
    // Get list of users (role = student)
...
<div class="container mt-5">
  ...
  <?php if ($user['role'] === 'admin'): ?>
    ...
    <a href="view_excuse_letters.php" class="btn btn-info">Review Excuse Letters</a>
  ...
  <?php elseif ($user['role'] === 'student'): ?>
    ...
    <a href="excuse_letter.php" class="btn btn-info">Submit Excuse Letter</a>

  <?php elseif ($user['role'] === 'teacher'): ?>
    <!-- TEACHER DASHBOARD (optional) -->
    <a href="mark_attendance.php" class="btn btn-primary">Mark Attendance</a>
    <a href="teacher_reports.php" class="btn btn-success">View Reports</a>
